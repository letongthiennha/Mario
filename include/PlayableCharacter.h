...
class PlayerData;
class Subject;
class PlayableCharacter: public Entity, public Subject {
    protected:
    //Image
        // Properties
        int lives;
       ...
       public:
           // Constructor
           // Full constructor
           PlayableCharacter(Vector2 pos, int lives = 3,
                 PlayerState form = PLAYER_STATE_SMALL);
           PlayableCharacter(Vector2 pos, const PlayerData &playerData);
           PlayableCharacter();
           // Destructor
